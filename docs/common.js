...
/***/ 6435:
/*!****************************************************!*\
  !*** ./src/app/services/device-storage.service.ts ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "DeviceStorageService": () => (/* binding */ DeviceStorageService)
/* harmony export */ });
...
let DeviceStorageService = class DeviceStorageService {
    set(key, value) {
        _capacitor_storage__WEBPACK_IMPORTED_MODULE_0__.Storage.set({
            key,
            value: JSON.stringify(value)
        });
    }
    get(key) {
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.from)(_capacitor_storage__WEBPACK_IMPORTED_MODULE_0__.Storage.get({ key })).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(prop => JSON.parse(prop.value)));
    }
};
DeviceStorageService = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "pathToImageUrl": () => (/* binding */ pathToImageUrl)
/* harmony export */ });
/* harmony import */ var _env_environment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @env/environment */ 2340);

const pathToImageUrl = (path) => (`${_env_environment__WEBPACK_IMPORTED_MODULE_0__.environment.supabaseUrl}/storage/v1/object/public/${path}`);
...
/* harmony import */ var _app_services_device_storage_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @app/services/device-storage.service */ 6435);
/* harmony import */ var _app_services_supabase_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @app/services/supabase.service */ 1829);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs/operators */ 9128);
...
let StoreService = class StoreService {
    constructor(supabase, deviceStorageService) {
        this.supabase = supabase;
        this.deviceStorageService = deviceStorageService;
        this.days$ = this.supabase.days$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.shareReplay)(1));
        this.artists$ = this.deviceStorageService.get('artists').pipe(
        // map((x: any) => x.map((y: any) => ({...y, name: 'Ole'}))),
        // tap(x => console.log('LS', x)),
        (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(() => this.supabase.artists$), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(artists => this.deviceStorageService.set('artists', artists)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.shareReplay)(1));
        this.dayMaskBounds$ = this.supabase.dayMaskBounds$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.shareReplay)(1));
    }
};
StoreService.ctorParameters = () => [
    { type: _app_services_supabase_service__WEBPACK_IMPORTED_MODULE_1__.SupabaseService },
    { type: _app_services_device_storage_service__WEBPACK_IMPORTED_MODULE_0__.DeviceStorageService }
];
StoreService = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
...
/* harmony export */ });
/* harmony import */ var _Users_baffioso_Documents_git_distortion_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 1670);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,_Users_baffioso_Documents_git_distortion_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,_Users_baffioso_Documents_git_distortion_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_Users_baffioso_Documents_git_distortion_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
const openURL = /*#__PURE__*/function () {
  var _ref = (0,_Users_baffioso_Documents_git_distortion_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url, ev, direction, animation) {
