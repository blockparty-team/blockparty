...
let AppComponent = class AppComponent {
    constructor() { }
    ngOnInit() {
        _capacitor_device__WEBPACK_IMPORTED_MODULE_3__.Device.getInfo().then(info => {
            if (info.platform !== 'web') {
                _capacitor_status_bar__WEBPACK_IMPORTED_MODULE_2__.StatusBar.setBackgroundColor({ color: '#c85c67' });
            }
        });
    }
};
    ...
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        ...
        imports: [
            ...
            _angular_service_worker__WEBPACK_IMPORTED_MODULE_8__.ServiceWorkerModule.register('ngsw-worker.js', {
                enabled: _env_environment__WEBPACK_IMPORTED_MODULE_2__.environment.production,
