...
/* harmony import */ var _store_store_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./store/store.service */ 2923);
...
let StoreService = class StoreService {
    constructor(supabase, deviceStorageService) {
        ...
        this._daysWithRelations$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__.BehaviorSubject(null);
        this.daysWithRelations$ = this._daysWithRelations$.asObservable();
        ...
        (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(() => this.supabase.artists$), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(artists => this.deviceStorageService.set('artists', artists)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.shareReplay)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(console.log));
    }
    updateEntities() {
        this.supabase.allEntities().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(entities => this._daysWithRelations$.next(entities))).subscribe();
    }
};
...
StoreService = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
