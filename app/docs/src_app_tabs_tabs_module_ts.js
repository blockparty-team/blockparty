        ...
        children: [
            {
                path: 'map',
                title: 'Map',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_tab-map_tab-map_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../tab-map/tab-map.module */ 1976)).then(m => m.TabMapPageModule)
            },
            {
                path: 'timetable',
                title: 'Timetable',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_tab-timetable_tab-timetable_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../tab-timetable/tab-timetable.module */ 4619)).then(m => m.TabTimetablePageModule)
            },
            {
                path: 'artist',
                title: 'Artist',
