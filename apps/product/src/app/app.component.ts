...
export class AppComponent implements OnInit {
  features = signal<Feature[]>([
    ...
    {
      title: 'Others',
      bullets: ['Partner branding', 'Push notifications', 'Custom pages'],
    ...
    {
      title: 'Editor',
      bullets: ['Edit app content', 'Upload artist images', 'Upload map icons'],
    ...
    {
      title: 'Analytics',
      bullets: ['Get stats on app usage', 'Liked artists', 'Feature usage'],
