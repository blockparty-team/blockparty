...
drop view if exists "public"."day_event_stage_timetable";

alter table "public"."event" add column "bounds" double precision[] generated always as (ARRAY[st_xmin((geom)::box3d), st_ymin((geom)::box3d), st_xmax((geom)::box3d), st_ymax((geom)::box3d)]) stored;

create or replace view "public"."day_event_mask" as  SELECT '52c29de2-fdd7-4b2b-bad9-9c8e68cdf7a4'::uuid AS id,
    st_difference(st_collect(m.geom), st_collect(e.geom)) AS geom,
