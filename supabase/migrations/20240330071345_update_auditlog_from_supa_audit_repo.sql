...
--rename existing audit.record_version table to audit.record_version_old
alter table audit.record_version rename to record_version_old;
...
select
    ...
    old_record
from
    audit.record_version_old;

drop table audit.record_version_old;
